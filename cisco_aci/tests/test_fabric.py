...
def test_fabric_mocked(aggregator):
    ...
    ### Fabric Port Metrics ###
    assert_fabric_port_egr_bytes_flood(aggregator)
    assert_fabric_port_egr_bytes_flood_cum(aggregator)
    assert_fabric_port_egr_bytes_multicast(aggregator)
    assert_fabric_port_egr_bytes_multicast_cum(aggregator)
    assert_fabric_port_egr_bytes_unicast(aggregator)
    assert_fabric_port_egr_bytes_unicast_cum(aggregator)
    assert_fabric_port_egr_drop_pkts_buffer(aggregator)
    assert_fabric_port_egr_drop_pkts_buffer_cum(aggregator)
    assert_fabric_port_egr_drop_pkts_errors(aggregator)
    assert_fabric_port_egr_total_bytes_cum(aggregator)
    assert_fabric_port_egr_total_bytes_rate(aggregator)
    assert_fabric_port_egr_total_pkts(aggregator)
    assert_fabric_port_egr_total_pkts_rate(aggregator)

    assert_fabric_port_ingr_bytes_flood(aggregator)
    assert_fabric_port_ingr_bytes_flood_cum(aggregator)
    assert_fabric_port_ingr_bytes_multicast(aggregator)
    assert_fabric_port_ingr_bytes_multicast_cum(aggregator)
    assert_fabric_port_ingr_bytes_unicast(aggregator)
    assert_fabric_port_ingr_bytes_unicast_cum(aggregator)
    assert_fabric_port_ingr_total_bytes_cum(aggregator)
    assert_fabric_port_ingr_total_bytes_rate(aggregator)
    assert_fabric_port_ingr_total_pkts(aggregator)
    assert_fabric_port_ingr_total_pkts_rate(aggregator)

    assert_fabric_port_fault_counter_crit(aggregator)
...
def assert_node_metric(aggregator, metric_name, metric_value, node_id):
    node_mapping = {
        "101": (tagsleaf101, hn101),
        "102": (tagsleaf102, hn102),
        "201": (tagsspine201, hn201),
        "202": (tagsspine202, hn202),
    }
    tags, hostname = node_mapping[node_id]
    aggregator.assert_metric(metric_name, value=metric_value, tags=tags, hostname=hostname)

def assert_node_metrics(aggregator, metric_name, metric_values, node_id):
    for metric_value in metric_values:
        assert_node_metric(aggregator, metric_name, metric_value, node_id)
...
def assert_fabric_node_cpu_avg(aggregator):
    ...
    assert_node_metrics(aggregator, metric_name, node_101_values, "101")
    ...
    assert_node_metrics(aggregator, metric_name, node_102_values, "102")
    ...
    assert_node_metrics(aggregator, metric_name, node_202_values, "202")
    ...
    assert_node_metrics(aggregator, metric_name, node_201_values, "201")
...
def generate_expected_interface_user_tag(node_id, port):
    node_mapping = {
        '101': 'default:10.0.200.0',
    }
    return 'dd.internal.resource:ndm_interface_user_tags:{}:{}'.format(node_mapping[node_id], port)

def assert_port_metric(aggregator, metric_name, values, node_id):
    pass

def assert_fabric_port_egr_bytes_flood(aggregator):
...
def assert_fabric_port_egr_bytes_flood_cum(aggregator):
...
def assert_fabric_port_egr_bytes_multicast(aggregator):
...
def assert_fabric_port_egr_bytes_multicast_cum(aggregator):
...
def assert_fabric_port_egr_bytes_unicast(aggregator):
...
def assert_fabric_port_egr_bytes_unicast_cum(aggregator):
...
def assert_fabric_port_egr_drop_pkts_buffer(aggregator):
...
def assert_fabric_port_egr_drop_pkts_buffer_cum(aggregator):
...
def assert_fabric_port_egr_drop_pkts_errors(aggregator):
...
def assert_fabric_port_egr_total_bytes_cum(aggregator):
...
def assert_fabric_port_egr_total_bytes_rate(aggregator):
...
def assert_fabric_port_egr_total_pkts(aggregator):
...
def assert_fabric_port_egr_total_pkts_rate(aggregator):
...
def assert_fabric_port_ingr_bytes_flood(aggregator):
...
def assert_fabric_port_ingr_bytes_flood_cum(aggregator):
...
def assert_fabric_port_ingr_bytes_multicast(aggregator):
...
def assert_fabric_port_ingr_bytes_multicast_cum(aggregator):
...
def assert_fabric_port_ingr_bytes_unicast(aggregator):
...
def assert_fabric_port_ingr_bytes_unicast_cum(aggregator):
...
def assert_fabric_port_ingr_total_bytes_cum(aggregator):
...
def assert_fabric_port_ingr_total_bytes_rate(aggregator):
...
def assert_fabric_port_ingr_total_pkts(aggregator):
...
def assert_fabric_port_ingr_total_pkts_rate(aggregator):
...
def assert_fabric_port_fault_counter_crit(aggregator):
