...
class MongoConfig(object):
    def __init__(self, instance, init_config, log):
        ...
        self.service_tag = self._compute_service_tag(instance, init_config)
    ...
    def _compute_service_tag(self, instance, init_config):
        if service := instance.get('service') or init_config.get('service'):
